...
public class TwitterAnalysis {
    ...
    // Filename
    public static String fileName = "datasets/twitter.txt";

    // Scanner to be able to read the contents from the file, then using the
    // contents make a graph with it
    ...
    // make the statements for commoninfluencers, smth about queries
    public void smth() {
    ...
    // This is how to write to a file, it'll print out the outputs by using this to
